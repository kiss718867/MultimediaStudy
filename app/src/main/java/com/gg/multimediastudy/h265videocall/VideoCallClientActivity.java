 ...
 * @description:
 * @author: XiaoChen
 * @date: 2021/01/21 23:53
 */

public class VideoCallClientActivity extends AppCompatActivity implements SocketLiveCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_call_client);
        initView();
    }
    ...
    public void connect(View view) {
        localSurfaceView.startCapture(LocalServiceView.TYPE_CLIENT, this);
    }
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, VideoCallClientActivity.class);
